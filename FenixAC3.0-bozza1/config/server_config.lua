...
FenixACS = {
	...
	KickMessage = "Sei stato bannato", -- ban / kick message

	ServerName 	= "FENIX-AC", -- Your fivem server name
	...
	Log = {
		...
		Discord = { -- here you can set discord webhook
			enable = true,
			image = true,
			webhook_ban 	= "set webhook",
			webhook_kick 	= "set webhook",
			webhook_warn 	= "set webhook",
			webhook_image 	= "set webhook",
			webhook_start 	= "set webhook",
		},
